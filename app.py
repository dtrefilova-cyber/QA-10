...
2. Дружелюбне питання / Мета дзвінка: якщо є дружнє питання або озвучена мета дзвінка → 2.5; якщо відсутнє → 0.
...
10. Якість мовлення: чітке, зрозуміле мовлення → 2.5; погане → 0.
