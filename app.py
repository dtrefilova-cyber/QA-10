...
- exact_time — якщо менеджер називає **будь-який конкретний час або інтервал**:
  приклади: "зателефоную після 18:00", "о 15:00", "завтра о 14", "через годину", "після обіду", "вранці", "увечері", "о другій" тощо.
  Навіть якщо це не точна хвилина — якщо згадується година/період дня — це exact_time.
- day — тільки день без вказівки часу (наприклад "завтра", "у понеділок")
- offer — просто "передзвоню", "зателефоную пізніше" без будь-якого часу
- none — немає жодної домовленості

Якщо є згадка про час/годину — обов'язково став "exact_time".

=== КРИТИЧНІ СИТУАЦІЇ ===
Якщо клієнт грубить, матюкається, кинув слухавку, за кермом, у лікарні або в зоні бойових дій — 
"Спроба презентації", "Пропозиція бонусу" та "Домовленість про наступний контакт" вважаються виконаними на максимум.
...
"""
    ...
    # ... решта коду функції без змін (try-except, defaults тощо)
